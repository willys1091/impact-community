...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark">Series</h1>
                    @if (session('status'))
            ...
            <div class="row mt-2">
                <div class="col-lg-4">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="p-3" method="post" action="{{ $type == 'edit' ? route('admin.series.update', $series->id) : route('admin.series.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    ...
                                    value="{{ $type == 'edit' ? $series->name : old('name') }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('url') is-invalid @enderror" id="inputurl"
                                    aria-describedby="" placeholder="Enter URL" name="url" value="{{ $type == 'edit' ? $series->url : old('url') }}">
                                @error('url')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.series.edit', ['series'=>$item->id])}}"
                                    class="badge badge-primary">Details</a>
                                    <form action="{{route('admin.series.destroy', ['series'=>$item->id])}}" method="post">
                                        @csrf
                                        @method('delete')
...
<div id="inline-content" style="display:none;">
    <div class="p-3 h-100">
        <form class="p-3" method="post" action="{{route('admin.series.store') }}"
