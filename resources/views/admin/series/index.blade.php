            ...
            <div class="row mt-2">
                <div class="col-lg-4">
                    <div class="card card-primary">
                        ...
                        <form class="p-3" method="post" action="{{ $type == 'edit' ? url('admin/series/'.$series->id) : url('admin/series') }}" enctype="multipart/form-data">@csrf
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$c->url}}</td>
                                <td>
                                    <a href="{{url('admin/series/'.$c->id.'/edit')}}"
                                    class="badge badge-primary">Details</a>
                                    <form action="{{url('admin/series/'.$c->id)}}" method="post"> @csrf @method('delete')
